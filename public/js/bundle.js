...
},{"./noConflict":"../../node_modules/@babel/polyfill/lib/noConflict.js","core-js/library/fn/global":"../../node_modules/core-js/library/fn/global.js"}],"../../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"axios":"../../node_modules/axios/index.js","../js/alert":"alert.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2hvc3Rqb3ZpbiIsImEiOiJjaXF4ZHVjNXYwMWlnZmttZ3ExZnZxcWFvIn0.ASJ7fbrCXlGsYMUNUW2cPA';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "Your ".concat(type, " have been updated successfully"));
          }
          _context.next = 10;
          break;
        case 7:
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51PWJLRRr7OGgTvDJ3KBa3eBdsHapMI6QyiVyJCMqArAbCm2FemRVo3EvT0XtC2EnZGhODntg0wweNqgpxIFVYMPG00BLl9H7RD');
          _context.prev = 1;
          _context.next = 4;
...
var btnText = document.querySelector('.btn--save-password');
...
},{"../../node_modules/@babel/polyfill":"../../node_modules/@babel/polyfill/lib/index.js","./login":"login.js","./mapbox":"mapbox.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
